...
function DialogDeleteUser({ openDeleteDialog, setOpenDialog, tableData, selectedUserId, setNewTableDataDeleted }) {
    ...
    >
        <DialogTitle id="responsive-dialog-title" color="error">
            ¿Estas segur@ que quieres eliminar el usuario {tableData[1]} ?
