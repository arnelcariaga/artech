...
export default function useDatatableOptions(products, setProduct) {
    ...
    const options = React.useMemo(() => {
        const opts = {
            ...
            renderExpandableRow: (rowData, rowMeta) => {
                ...
                return (
                    ...
                    >
                        <TableCell component="th" scope="row">C&oacute;digo:</TableCell>
                        <TableCell>{data[6]}</TableCell>
                        <TableCell component="th" scope="row">Costo:</TableCell>
        ...
        return opts
    }, [categories, cost, disableRegisterBtn, errors.category, errors.cost, errors.name, errors.price, errors.qr, errors.quantity, fullScreen, handleSubmit, openDialog, openSnackError, pTData, price, products, register, registerStatus, reset, selectPT, setProduct])
